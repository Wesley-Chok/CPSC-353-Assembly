...
section .data
    ...
    sumOutputPrompt db "The sum of these values is %1.8lf",10,0
...
_first:
    ...
    push qword 0
    mov qword rax, 1
    mov qword rdi, sumOutputPrompt        ;"The sum of these values is %1.8lf"
    call printf
    pop rax
    ...
    movsd xmm0, xmm14                       ;Moves the scalar double-precision floating-point value register xmm12 to register xmm0         
